...
const FAKE_USER_ACCOUNTS = [
  // Rap-style names
  { id: -1,   username: "LilSavage",      artistName: "Lil Savage",    role: "user" as const },
  { id: -2,   username: "YoungBlood",      artistName: "YoungBlood",    role: "user" as const },
  { id: -3,   username: "TrapKing",        artistName: "Trap King",     role: "user" as const },
  { id: -4,   username: "BigFlex",         artistName: "Big Flex",      role: "user" as const },
  { id: -5,   username: "SlimDuece",       artistName: "Slim Duece",    role: "user" as const },
  { id: -6,   username: "DoughBoy",        artistName: "Dough Boy",     role: "user" as const },
  { id: -7,   username: "GhostFace",       artistName: "Ghost Face",    role: "user" as const },
  { id: -8,   username: "LilReek",         artistName: "Lil Reek",      role: "user" as const },
  { id: -9,   username: "YoungKing",       artistName: "Young King",    role: "user" as const },
  { id: -10,  username: "BigBando",        artistName: "Big Bando",     role: "user" as const },
  { id: -11,  username: "TrapStar",        artistName: "Trap Star",     role: "user" as const },
  { id: -12,  username: "LilGrip",         artistName: "Lil Grip",      role: "user" as const },
  { id: -13,  username: "YoungDre",        artistName: "Young Dre",     role: "user" as const },
  { id: -14,  username: "BigSlime",        artistName: "Big Slime",     role: "user" as const },
  { id: -15,  username: "LilTrap",         artistName: "Lil Trap",      role: "user" as const },
  { id: -16,  username: "SlimShady99",     artistName: "Slim Shady 99", role: "user" as const },
  { id: -17,  username: "YoungMoney",      artistName: "Young Money",   role: "user" as const },
  { id: -18,  username: "BigCash",         artistName: "Big Cash",      role: "user" as const },
  { id: -19,  username: "LilDuece",        artistName: "Lil Duece",     role: "user" as const },
  { id: -20,  username: "TrapGod",         artistName: "Trap God",      role: "user" as const },
  { id: -21,  username: "YoungSavage",     artistName: "Young Savage",  role: "user" as const },
  { id: -22,  username: "BigDrako",        artistName: "Big Drako",     role: "user" as const },
  { id: -23,  username: "LilBando",        artistName: "Lil Bando",     role: "user" as const },
  { id: -24,  username: "SlimBaller",      artistName: "Slim Baller",   role: "user" as const },
  { id: -25,  username: "YoungFlame",      artistName: "Young Flame",   role: "user" as const },
  // Real-sounding names
  { id: -26,  username: "Marcus_D",        artistName: "Marcus D",      role: "user" as const },
  { id: -27,  username: "DeShawn",         artistName: "DeShawn",       role: "user" as const },
  { id: -28,  username: "Jayvon",          artistName: "Jayvon",        role: "user" as const },
  { id: -29,  username: "TyreekM",         artistName: "Tyreek M",      role: "user" as const },
  { id: -30,  username: "Darius_K",        artistName: "Darius K",      role: "user" as const },
  { id: -31,  username: "Malik_J",         artistName: "Malik J",       role: "user" as const },
  { id: -32,  username: "Kevon",           artistName: "Kevon",         role: "user" as const },
  { id: -33,  username: "Rashad_P",        artistName: "Rashad P",      role: "user" as const },
  { id: -34,  username: "Donte",           artistName: "Donte",         role: "user" as const },
  { id: -35,  username: "Jamal_W",         artistName: "Jamal W",       role: "user" as const },
  { id: -36,  username: "Terrell",         artistName: "Terrell",       role: "user" as const },
  { id: -37,  username: "Quincy_B",        artistName: "Quincy B",      role: "user" as const },
  { id: -38,  username: "Devontae",        artistName: "Devontae",      role: "user" as const },
  { id: -39,  username: "Lamar_G",         artistName: "Lamar G",       role: "user" as const },
  { id: -40,  username: "Kendrick_F",      artistName: "Kendrick F",    role: "user" as const },
  { id: -41,  username: "Darnell",         artistName: "Darnell",       role: "user" as const },
  { id: -42,  username: "Jalen_R",         artistName: "Jalen R",       role: "user" as const },
  { id: -43,  username: "Antoine",         artistName: "Antoine",       role: "user" as const },
  { id: -44,  username: "Marquise",        artistName: "Marquise",      role: "user" as const },
  { id: -45,  username: "Dominic_T",       artistName: "Dominic T",     role: "user" as const },
  { id: -46,  username: "Reginald",        artistName: "Reginald",      role: "user" as const },
  { id: -47,  username: "Dwayne_L",        artistName: "Dwayne L",      role: "user" as const },
  { id: -48,  username: "Cortez",          artistName: "Cortez",        role: "user" as const },
  { id: -49,  username: "Elijah_M",        artistName: "Elijah M",      role: "user" as const },
  { id: -50,  username: "Bryce_H",         artistName: "Bryce H",       role: "user" as const },
  // One-word nicknames
  { id: -51,  username: "Blaze",           artistName: "Blaze",         role: "user" as const },
  { id: -52,  username: "Phantom",         artistName: "Phantom",       role: "user" as const },
  { id: -53,  username: "Venom",           artistName: "Venom",         role: "user" as const },
  { id: -54,  username: "Reaper",          artistName: "Reaper",        role: "user" as const },
  { id: -55,  username: "Cipher",          artistName: "Cipher",        role: "user" as const },
  { id: -56,  username: "Drako",           artistName: "Drako",         role: "user" as const },
  { id: -57,  username: "Steelo",          artistName: "Steelo",        role: "user" as const },
  { id: -58,  username: "Grimy",           artistName: "Grimy",         role: "user" as const },
  { id: -59,  username: "Hustle",          artistName: "Hustle",        role: "user" as const },
  { id: -60,  username: "Grind",           artistName: "Grind",         role: "user" as const },
  { id: -61,  username: "Clutch",          artistName: "Clutch",        role: "user" as const },
  { id: -62,  username: "Finesse",         artistName: "Finesse",       role: "user" as const },
  { id: -63,  username: "Savage",          artistName: "Savage",        role: "user" as const },
  { id: -64,  username: "Menace",          artistName: "Menace",        role: "user" as const },
  { id: -65,  username: "Reckless",        artistName: "Reckless",      role: "user" as const },
  { id: -66,  username: "Wraith",          artistName: "Wraith",        role: "user" as const },
  { id: -67,  username: "Specter",         artistName: "Specter",       role: "user" as const },
  { id: -68,  username: "Cobra",           artistName: "Cobra",         role: "user" as const },
  { id: -69,  username: "Viper",           artistName: "Viper",         role: "user" as const },
  { id: -70,  username: "Trigger",         artistName: "Trigger",       role: "user" as const },
  { id: -71,  username: "Bandit",          artistName: "Bandit",        role: "user" as const },
  { id: -72,  username: "Rogue",           artistName: "Rogue",         role: "user" as const },
  { id: -73,  username: "Stealth",         artistName: "Stealth",       role: "user" as const },
  { id: -74,  username: "Maverick",        artistName: "Maverick",      role: "user" as const },
  { id: -75,  username: "Outlaw",          artistName: "Outlaw",        role: "user" as const },
  { id: -76,  username: "Rebel",           artistName: "Rebel",         role: "user" as const },
  { id: -77,  username: "Chaos",           artistName: "Chaos",         role: "user" as const },
  { id: -78,  username: "Havoc",           artistName: "Havoc",         role: "user" as const },
  { id: -79,  username: "Mayhem",          artistName: "Mayhem",        role: "user" as const },
  { id: -80,  username: "Carnage",         artistName: "Carnage",       role: "user" as const },
  { id: -81,  username: "Rampage",         artistName: "Rampage",       role: "user" as const },
  { id: -82,  username: "Fury",            artistName: "Fury",          role: "user" as const },
  { id: -83,  username: "Wrath",           artistName: "Wrath",         role: "user" as const },
  { id: -84,  username: "Rage",            artistName: "Rage",          role: "user" as const },
  { id: -85,  username: "Storm",           artistName: "Storm",         role: "user" as const },
  { id: -86,  username: "Thunder",         artistName: "Thunder",       role: "user" as const },
  { id: -87,  username: "Lightning",       artistName: "Lightning",     role: "user" as const },
  { id: -88,  username: "Voltage",         artistName: "Voltage",       role: "user" as const },
  { id: -89,  username: "Surge",           artistName: "Surge",         role: "user" as const },
  { id: -90,  username: "Pulse",           artistName: "Pulse",         role: "user" as const },
  { id: -91,  username: "Flux",            artistName: "Flux",          role: "user" as const },
  { id: -92,  username: "Nuke",            artistName: "Nuke",          role: "user" as const },
  { id: -93,  username: "Bomb",            artistName: "Bomb",          role: "user" as const },
  { id: -94,  username: "Rocket",          artistName: "Rocket",        role: "user" as const },
  { id: -95,  username: "Missile",         artistName: "Missile",       role: "user" as const },
  { id: -96,  username: "Cannon",          artistName: "Cannon",        role: "user" as const },
  { id: -97,  username: "Bullet",          artistName: "Bullet",        role: "user" as const },
  { id: -98,  username: "Blade",           artistName: "Blade",         role: "user" as const },
  { id: -99,  username: "Dagger",          artistName: "Dagger",        role: "user" as const },
  { id: -100, username: "Saber",           artistName: "Saber",         role: "user" as const },
  // Extra User-style IDs for realism
  { id: -101, username: "User19273930",    artistName: null,            role: "user" as const },
  { id: -102, username: "User84720193",    artistName: null,            role: "user" as const },
  { id: -103, username: "User30482910",    artistName: null,            role: "user" as const },
  { id: -104, username: "User57391820",    artistName: null,            role: "user" as const },
