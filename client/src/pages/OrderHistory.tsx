...
function BeatOrderStatus({ sale }: { sale: any }) {
  if (sale.status === "paid") {
    if (sale.masterDeliveryStatus === "producer_required") return <span className="border border-yellow-400/35 bg-yellow-400/10 px-2.5 py-1 text-[9px] font-black uppercase tracking-widest text-yellow-200">Master coming from producer</span>;
